...
joint.shapes.logic.Assertion = joint.shapes.basic.Generic.extend({

    markup: '<g class="rotatable"><g class="scalable"><rect class="body"/></g><circle/><text/></g>',

    defaults: _.defaultsDeep({

        type: 'logic.Assertion',
        size: { width: 170, height: 30 },
        attrs: {
            '.body': { width: 300, height: 50, fill: 'white', stroke: 'black', 'stroke-width': 2 },
            circle: { r: 7, stroke: 'black', fill: 'transparent', 'stroke-width': 2, ref: '.body', 'ref-x': .5, 'ref-y': 38, magnet: 'passive', 'class': 'input', port: 'in' },
            '.': { magnet: false },
            text: {
                fill: 'black',
...
joint.shapes.logic.IO = joint.shapes.logic.Gate.extend({
    ...
    defaults: _.defaultsDeep({
        ...
        type: 'logic.IO',
        size: { width: 198, height: 35 },
        attrs: {
            '.body': { fill: '#c1c1c1', stroke: 'black', 'stroke-width': 2 },
...
joint.shapes.logic.Gate11 = joint.shapes.logic.Gate.extend({
    ...
    markup: '<g class="rotatable"><g class="scalable"><image class="body"/></g><circle class="input"/><circle class="output"/><text/></g>',

    defaults: _.defaultsDeep({

        type: 'logic.Gate11',
        attrs: {
            '.input': { ref: '.body', 'ref-x': -2, 'ref-y': 0.4, magnet: 'passive', port: 'in' },
            '.output': { ref: '.body', 'ref-dx': 2, 'ref-y': 0.4, magnet: true, port: 'out' }
        }
...
joint.shapes.logic.Gate21 = joint.shapes.logic.Gate.extend({
    ...
    markup: '<g class="rotatable"><g class="scalable"><image class="body"/></g><circle class="input input1"/><circle  class="input input2"/><circle class="output"/><text/></g>',

    defaults: _.defaultsDeep({

        type: 'logic.Gate21',
        attrs: {
            '.input1': { ref: '.body', 'ref-x': -1, 'ref-y': 0.26, magnet: 'passive', port: 'in1' },
            '.input2': { ref: '.body', 'ref-x': -1, 'ref-y': 0.53, magnet: 'passive', port: 'in2' },
            '.output': { ref: '.body', 'ref-dx': 1, 'ref-y': 0.4, magnet: true, port: 'out' }
        }
...
joint.shapes.logic.Gaininv = joint.shapes.logic.Gate11.extend({

    defaults: _.defaultsDeep({

        type: 'logic.Gaininv',
        attrs: { image: { 'xlink:href': './media/gaininv_wide.svg' },
        text: { text: 'inverting gain', 'ref-x': '50%', 'ref-y': '80%' }
    },

        modulename: 'gaininv',
        //simplename: 'inverting gain',
...
joint.shapes.logic.PlotView = joint.dia.ElementView.extend({
    template: [

        '<div class="plotcanvas" tag="plotcanvas">',
        '</div>',
        '<div class="deletediv" tag="deletediv">',
        '</div>',
        '<div class="paramdiv" tag="paramdiv">',
        '</div>',
        '<div class="visualizeCheckbox" tag="visualizeCheckbox"',
        '</div>'
    ...
    initialize: function() {
        ...
        this.$plot = $(this.$box[0]);
        this.$deletediv = $(this.$box[1]);
        this.$paramdiv = $(this.$box[2]);
        this.$visualizeCheckbox = $(this.$box[3]);

        // plot
        this.$box[0].style.zIndex = "4";
        this.$box[0].style.width = "102px";
        this.$box[0].style.height = "45px";
        this.$box[0].style.position = "absolute";

        this.$box[0].style.borderStyle = "solid";
        this.$box[0].style.borderColor = '#000000';
        this.$box[0].style.borderRadius = '1px';
        this.$box[0].style.paddingLeft = '95px';
        this.$box[0].style.paddingTop = '3px';
        // this.$box[0].style.float = 'right';
        // this.$box[0].style.right = '0px';

        // the plot itself
        // var thePlot = $(this.$box[0]).find('plot');
        // thePlot.css('textAlign', 'right');
        // this.$box[0][0].style.margin="auto";
        // this.$box[0][0].style.display="block";

        // deletediv
        this.$box[1].style.zIndex = "4";
        //this.$box[1].style.width = "100px";
        //this.$box[1].style.height = "40px";
        this.$box[1].style.position = "absolute";
        this.$box[1].style.lineHeight = "10%";

        // paramdiv
        this.$box[2].style.zIndex = "4";
        //this.$box[1].style.width = "100px";
        //this.$box[1].style.height = "40px";
        this.$box[2].style.fontSize = "12px";
        this.$box[2].style.backgroundColor = "#ffffff";
        this.$box[2].style.position = "absolute";


        // input has no parameters, so its div will be empty
        if (!(this.model instanceof joint.shapes.logic.Input))
        {
            this.$box[2].style.borderStyle = "solid";
            this.$box[2].style.borderColor = '#000000';
            this.$box[2].style.borderRadius = '1px';
        }

        this.$box[2].style.paddingLeft = '2px';
        this.$box[2].style.paddingRight = '2px';
        this.$box[2].style.paddingTop = '0px';
        this.$box[2].style.paddingBottom = '0px';
        this.$box[2].style.width = '193px';

        this.$box[3].style.zIndex = "4";
        this.$box[3].style.position = "absolute";
        // this.$box[2].style.marginLeft = '2px';
        // this.$box[2].style.marginRight = '2px';
        // this.$box[2].style.marginTop = '2px';
        // this.$box[2].style.marginBottom = '2px';
        this.updateBox();
    },
    render: function() {
        joint.dia.ElementView.prototype.render.apply(this, arguments);
    ...
    updateBox: function() {
        ...
        this.$plot.offset({left:bbox.x - subtractorX + .13 * bbox.width, top:bbox.y - subtractorY + 1.85*bbox.height * scaleFactor});
        this.$deletediv.offset({left:bbox.x - subtractorX + .13 * bbox.width, top:bbox.y - subtractorY + .635 *bbox.height * scaleFactor});
        this.$paramdiv.offset({left:bbox.x - subtractorX + .13 * bbox.width, top:bbox.y - subtractorY + 2.53*bbox.height * scaleFactor});
        this.$visualizeCheckbox.offset({left:bbox.x - subtractorX + .15 * bbox.width, top:bbox.y - subtractorY + 2.2*bbox.height * scaleFactor});

        // For comparators: only show the second input if the mode is set to dual-input
        if (this.model instanceof joint.shapes.logic.Comparator)
        {
            if (this.model.get('mode') != 2)
            {
                //this.model.attr('[port="in2"]/fill', '#505050');
                this.model.attr('[port="in2"]/stroke', 'rgba(0,0,0,0)');
                this.model.attr('[port="in2"]/magnet', false);
            }
            else
            {
                //this.model.attr('[port="in2"]/fill', '#ffffff');
                this.model.attr('[port="in2"]/stroke', '#000000');
                this.model.attr('[port="in2"]/magnet', true);
            }
        }
...
joint.shapes.logic.InputView = joint.shapes.logic.PlotView;
joint.shapes.logic.GaininvView = joint.shapes.logic.PlotView;
joint.shapes.logic.FilterView = joint.shapes.logic.PlotView;
joint.shapes.logic.ComparatorView = joint.shapes.logic.PlotView;
joint.shapes.logic.SumView = joint.shapes.logic.PlotView;
joint.shapes.logic.DifferenceView = joint.shapes.logic.PlotView;

joint.shapes.logic.AssertionView = joint.dia.ElementView.extend({
    template: [
    ...
    initialize: function() {
        ...
        this.$box = $(_.template(this.template)());
        this.$deletediv = $(this.$box[0]);
        //this.$paramdiv = $(this.$box[1]);
        ...
        //this.$box[1].style.height = "40px";
        this.$box[0].style.position = "absolute";
        this.$box[0].style.lineHeight = "10%";
    ...
    updateBox: function() {
        ...
        this.$deletediv.offset({left:bbox.x + .146 * bbox.width, top:bbox.y + 1.45 *bbox.height});
        //this.$paramdiv.offset({left:bbox.x + .18 * bbox.width, top:bbox.y + 2.85*bbox.height});
...
joint.shapes.logic.Filter = joint.shapes.logic.Gate11.extend({

    defaults: _.defaultsDeep({

        type: 'logic.Filter',
        attrs: { image: { 'xlink:href': './media/filter_wide.svg' },
        text: { text: 'filter', 'ref-x': '50%', 'ref-y': '80%' }
        },


        modulename: 'filterbiquad',

        gain: '1.0',
        cornerfrequency: "40.0",
        q: ".707",
        filtertype: "0",
        inputsamplingphase:"1",
        outputpolarity:"0"
    }, joint.shapes.logic.Gate11.prototype.defaults),

});

joint.shapes.logic.Comparator = joint.shapes.logic.Gate21.extend({

    defaults: _.defaultsDeep({

        type: 'logic.Comparator',
        attrs: { image: { 'xlink:href': './media/comparator_wide.svg' },
        text: { text: 'comparator', 'ref-x': '50%', 'ref-y': '80%' }
        },
...
joint.shapes.logic.Sum = joint.shapes.logic.Gate21.extend({
    ...
    defaults: _.defaultsDeep({
        ...
        type: 'logic.Sum',
        attrs: { image: { 'xlink:href': './media/sum_wide.svg' },
        text: { text: 'sum', 'ref-x': '50%', 'ref-y': '80%' }
        },


        modulename: 'sumfilter',

        gain1: '1.0',
        gain2: '1.0',
        cornerfrequency: '1600.0'
    }, joint.shapes.logic.Gate21.prototype.defaults),
...
joint.shapes.logic.Difference = joint.shapes.logic.Gate21.extend({

    defaults: _.defaultsDeep({

        type: 'logic.Difference',
        attrs: { image: { 'xlink:href': './media/difference_wide.svg' },
        text: { text: 'difference', 'ref-x': '50%', 'ref-y': '80%' }
        },
...
joint.shapes.logic.Wire = joint.shapes.devs.Link.extend({
